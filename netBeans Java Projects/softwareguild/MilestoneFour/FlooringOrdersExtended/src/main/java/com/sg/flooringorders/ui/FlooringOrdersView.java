...
//        io.print("Customer Name: " + order.getCustomerName() + ", Order Date: " + order.getDate() + ", Material: " + order.getProduct().getProductType() + ", Area: " + order.getArea() + ", Total: " + order.getTotal());
        if (order.getOrderNumber() != 0) {
            io.print("Order ID: " + order.getOrderNumber() + ", ", false);
        }
        io.print("Customer Name: " + order.getCustomerName() + ", Order Date: " + order.getDate() + ", Total: " + order.getTotal());
        this.displayIndOrders(order.getOrders().values());
        io.print("");
    }
    
    public void displayIndOrders (Collection<IndOrder> orders) {
        orders.stream()
                .forEach(o -> io.print("Item: " + o.getOrderNumber() + ", Product Name: " + o.getProduct().getProductType() + ", Area: " + o.getArea() + ", SubTotal: " + (o.getLaborCost().add(o.getMaterialCost()))));
    }
    ...
    public String getNewOrderData(String prompt) {
        return io.readString(prompt);
    }
    
    public String getNewOrderDataCustomer() {
        return io.readString("Customer Name: ");
    }
    
    public String getNewOrderDataState() {
        return io.readString("State (i.e. NY): ");
    }
    
    public String getNewOrderDataArea() {
        return io.readString("Area: ");
    }
    
    public String getNewOrderDataProduct() {
        return io.readString("Material: ");
    }
