...
public class Opinionator {
     public static void main(String[] args) {
        ...
        //randomizer.nextInt generates a random integer between 0 (inclusive) and up to n (exclusive).
        //Thus, n cannot be one of the values we wish to attain, so I've replaced 5 with 6
