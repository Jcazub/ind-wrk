...
public class MakeTags {
    ...
    public String makeTags(String tag, String content) throws Section03UnitTestsException {
        if (tag == "") {
            throw new Section03UnitTestsException("Tag field empty");
        }
        
        if (content == "") {
            throw new Section03UnitTestsException("Content field empty");
        }
